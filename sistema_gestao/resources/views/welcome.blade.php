    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-1 lg:gap-8 flex items-center justify-center">
                        <div class="col-lg-12 ">
                            <div class="p-4 p-md-5 mb-4 rounded text-bg-dark text-center">
                                <div class="col-md-6 px-0">
                                    <h1 class="display-4 fst-italic text-white">Sistema de Gestão</h1>
                                    <p class="lead my-3 text-grey">O projeto de sistema de gestão foi desenvolvido por
                                        José Dagmar para o processo seletivo da vaga de Desenvolvedor(a) Laravel Júnior
                                        da empresa VOCH TECH. Esse sistema foi desenvolvido para um grupo econômico que
                                        possui várias bandeiras, unidades e colaboradores. Ele deve permitir a
                                        administração de grupos econômicos, bandeiras, unidades e colaboradores, além de
                                        permitir a consulta de relatórios. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    Projeto desenvolvido por José Dagmar Florentino da Silva Sobrinho
                </footer>
            </div>
        </div>
    </div>
